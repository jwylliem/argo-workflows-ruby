...
begin
  ...
  result = api_instance.create_sensor(namespace, body)
  p result
rescue ArgoWorkflows::ApiError => e
  puts "Error when calling SensorServiceApi->create_sensor: #{e}"
end
```

#### Using the create_sensor_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<IoArgoprojEventsV1alpha1Sensor>, Integer, Hash)> create_sensor_with_http_info(namespace, body)

```ruby
begin
  
  data, status_code, headers = api_instance.create_sensor_with_http_info(namespace, body)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <IoArgoprojEventsV1alpha1Sensor>
rescue ArgoWorkflows::ApiError => e
  puts "Error when calling SensorServiceApi->create_sensor_with_http_info: #{e}"
end
```
...
> Object delete_sensor(namespace, name, opts)
...
begin
  ...
  result = api_instance.delete_sensor(namespace, name, opts)
  p result
rescue ArgoWorkflows::ApiError => e
  puts "Error when calling SensorServiceApi->delete_sensor: #{e}"
end
```

#### Using the delete_sensor_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(Object, Integer, Hash)> delete_sensor_with_http_info(namespace, name, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.delete_sensor_with_http_info(namespace, name, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => Object
rescue ArgoWorkflows::ApiError => e
  puts "Error when calling SensorServiceApi->delete_sensor_with_http_info: #{e}"
end
```
...
> <IoArgoprojEventsV1alpha1Sensor> get_sensor(namespace, name, opts)
...
begin
  ...
  result = api_instance.get_sensor(namespace, name, opts)
  p result
rescue ArgoWorkflows::ApiError => e
  puts "Error when calling SensorServiceApi->get_sensor: #{e}"
end
```

#### Using the get_sensor_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<IoArgoprojEventsV1alpha1Sensor>, Integer, Hash)> get_sensor_with_http_info(namespace, name, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.get_sensor_with_http_info(namespace, name, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <IoArgoprojEventsV1alpha1Sensor>
rescue ArgoWorkflows::ApiError => e
  puts "Error when calling SensorServiceApi->get_sensor_with_http_info: #{e}"
end
```
...
> <IoArgoprojEventsV1alpha1SensorList> list_sensors(namespace, opts)
...
begin
  ...
  result = api_instance.list_sensors(namespace, opts)
  p result
rescue ArgoWorkflows::ApiError => e
  puts "Error when calling SensorServiceApi->list_sensors: #{e}"
end
```

#### Using the list_sensors_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<IoArgoprojEventsV1alpha1SensorList>, Integer, Hash)> list_sensors_with_http_info(namespace, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.list_sensors_with_http_info(namespace, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <IoArgoprojEventsV1alpha1SensorList>
rescue ArgoWorkflows::ApiError => e
  puts "Error when calling SensorServiceApi->list_sensors_with_http_info: #{e}"
end
```
...
> <StreamResultOfSensorLogEntry> sensors_logs(namespace, opts)
...
begin
  ...
  result = api_instance.sensors_logs(namespace, opts)
  p result
rescue ArgoWorkflows::ApiError => e
  puts "Error when calling SensorServiceApi->sensors_logs: #{e}"
end
```

#### Using the sensors_logs_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<StreamResultOfSensorLogEntry>, Integer, Hash)> sensors_logs_with_http_info(namespace, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.sensors_logs_with_http_info(namespace, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <StreamResultOfSensorLogEntry>
rescue ArgoWorkflows::ApiError => e
  puts "Error when calling SensorServiceApi->sensors_logs_with_http_info: #{e}"
end
```
...
begin
  ...
  result = api_instance.update_sensor(namespace, name, body)
  p result
rescue ArgoWorkflows::ApiError => e
  puts "Error when calling SensorServiceApi->update_sensor: #{e}"
end
```

#### Using the update_sensor_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<IoArgoprojEventsV1alpha1Sensor>, Integer, Hash)> update_sensor_with_http_info(namespace, name, body)

```ruby
begin
  
  data, status_code, headers = api_instance.update_sensor_with_http_info(namespace, name, body)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <IoArgoprojEventsV1alpha1Sensor>
rescue ArgoWorkflows::ApiError => e
  puts "Error when calling SensorServiceApi->update_sensor_with_http_info: #{e}"
end
```
...
> <StreamResultOfSensorSensorWatchEvent> watch_sensors(namespace, opts)
...
begin
  ...
  result = api_instance.watch_sensors(namespace, opts)
  p result
rescue ArgoWorkflows::ApiError => e
  puts "Error when calling SensorServiceApi->watch_sensors: #{e}"
end
```

#### Using the watch_sensors_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<StreamResultOfSensorSensorWatchEvent>, Integer, Hash)> watch_sensors_with_http_info(namespace, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.watch_sensors_with_http_info(namespace, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <StreamResultOfSensorSensorWatchEvent>
rescue ArgoWorkflows::ApiError => e
  puts "Error when calling SensorServiceApi->watch_sensors_with_http_info: #{e}"
end
```
