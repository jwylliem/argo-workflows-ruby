...
module ArgoWorkflows
  class ArchivedWorkflowServiceApi
    ...
    # @return [Object]
    def delete_archived_workflow(uid, opts = {})
      data, _status_code, _headers = delete_archived_workflow_with_http_info(uid, opts)
      data
    end
    ...
    def delete_archived_workflow_with_http_info(uid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ArchivedWorkflowServiceApi.delete_archived_workflow ...'
      end
      # verify the required parameter 'uid' is set
      if @api_client.config.client_side_validation && uid.nil?
        fail ArgumentError, "Missing the required parameter 'uid' when calling ArchivedWorkflowServiceApi.delete_archived_workflow"
      end
      # resource path
      local_var_path = '/api/v1/archived-workflows/{uid}'.sub('{' + 'uid' + '}', CGI.escape(uid.to_s))
      ...
      new_options = opts.merge(
        :operation => :"ArchivedWorkflowServiceApi.delete_archived_workflow",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ArchivedWorkflowServiceApi#delete_archived_workflow\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def get_archived_workflow(uid, opts = {})
      data, _status_code, _headers = get_archived_workflow_with_http_info(uid, opts)
      data
    end
    ...
    def get_archived_workflow_with_http_info(uid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ArchivedWorkflowServiceApi.get_archived_workflow ...'
      end
      # verify the required parameter 'uid' is set
      if @api_client.config.client_side_validation && uid.nil?
        fail ArgumentError, "Missing the required parameter 'uid' when calling ArchivedWorkflowServiceApi.get_archived_workflow"
      end
      # resource path
      local_var_path = '/api/v1/archived-workflows/{uid}'.sub('{' + 'uid' + '}', CGI.escape(uid.to_s))
      ...
      new_options = opts.merge(
        :operation => :"ArchivedWorkflowServiceApi.get_archived_workflow",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ArchivedWorkflowServiceApi#get_archived_workflow\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def list_archived_workflow_label_keys(opts = {})
      data, _status_code, _headers = list_archived_workflow_label_keys_with_http_info(opts)
      data
    end

    # @param [Hash] opts the optional parameters
    # @return [Array<(IoArgoprojWorkflowV1alpha1LabelKeys, Integer, Hash)>] IoArgoprojWorkflowV1alpha1LabelKeys data, response status code and response headers
    def list_archived_workflow_label_keys_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ArchivedWorkflowServiceApi.list_archived_workflow_label_keys ...'
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'IoArgoprojWorkflowV1alpha1LabelKeys'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"ArchivedWorkflowServiceApi.list_archived_workflow_label_keys",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ArchivedWorkflowServiceApi#list_archived_workflow_label_keys\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def list_archived_workflow_label_values(opts = {})
      data, _status_code, _headers = list_archived_workflow_label_values_with_http_info(opts)
      data
    end
    ...
    # @option opts [String] :list_options_limit limit is a maximum number of responses to return for a list call. If more items exist, the server will set the &#x60;continue&#x60; field on the list metadata to a value that can be used with the same initial query to retrieve the next set of results. Setting a limit may return fewer than the requested amount of items (up to zero items) in the event all requested objects are filtered out and clients should only use the presence of the continue field to determine whether more results are available. Servers may choose not to support the limit argument and will return all of the available results. If limit is specified and the continue field is empty, clients may assume that no more results are available. This field is not supported if watch is true.  The server guarantees that the objects returned when using continue will be identical to issuing a single list call without a limit - that is, no objects created, modified, or deleted after the first request is issued will be included in any subsequent continued requests. This is sometimes referred to as a consistent snapshot, and ensures that a client that is using limit to receive smaller chunks of a very large result can ensure they see all possible objects. If objects are updated during a chunked list the version of the object that was present at the time the first list result was calculated is returned.
    # @option opts [String] :list_options_continue The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the \&quot;next key\&quot;.  This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.
    # @return [Array<(IoArgoprojWorkflowV1alpha1LabelValues, Integer, Hash)>] IoArgoprojWorkflowV1alpha1LabelValues data, response status code and response headers
    def list_archived_workflow_label_values_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ArchivedWorkflowServiceApi.list_archived_workflow_label_values ...'
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'IoArgoprojWorkflowV1alpha1LabelValues'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"ArchivedWorkflowServiceApi.list_archived_workflow_label_values",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ArchivedWorkflowServiceApi#list_archived_workflow_label_values\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def list_archived_workflows(opts = {})
      data, _status_code, _headers = list_archived_workflows_with_http_info(opts)
      data
    end
    ...
    def list_archived_workflows_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ArchivedWorkflowServiceApi.list_archived_workflows ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"ArchivedWorkflowServiceApi.list_archived_workflows",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ArchivedWorkflowServiceApi#list_archived_workflows\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
