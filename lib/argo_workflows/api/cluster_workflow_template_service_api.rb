...
module ArgoWorkflows
  class ClusterWorkflowTemplateServiceApi
    ...
    # @param body [IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplateCreateRequest] 
    # @param [Hash] opts the optional parameters
    # @return [IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplate]
    def create_cluster_workflow_template(body, opts = {})
      data, _status_code, _headers = create_cluster_workflow_template_with_http_info(body, opts)
      data
    end

    # @param body [IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplateCreateRequest] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplate, Integer, Hash)>] IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplate data, response status code and response headers
    def create_cluster_workflow_template_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ClusterWorkflowTemplateServiceApi.create_cluster_workflow_template ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ClusterWorkflowTemplateServiceApi.create_cluster_workflow_template"
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplate'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"ClusterWorkflowTemplateServiceApi.create_cluster_workflow_template",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ClusterWorkflowTemplateServiceApi#create_cluster_workflow_template\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @return [Object]
    def delete_cluster_workflow_template(name, opts = {})
      data, _status_code, _headers = delete_cluster_workflow_template_with_http_info(name, opts)
      data
    end
    ...
    def delete_cluster_workflow_template_with_http_info(name, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ClusterWorkflowTemplateServiceApi.delete_cluster_workflow_template ...'
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling ClusterWorkflowTemplateServiceApi.delete_cluster_workflow_template"
      end
      # resource path
      local_var_path = '/api/v1/cluster-workflow-templates/{name}'.sub('{' + 'name' + '}', CGI.escape(name.to_s))
      ...
      new_options = opts.merge(
        :operation => :"ClusterWorkflowTemplateServiceApi.delete_cluster_workflow_template",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ClusterWorkflowTemplateServiceApi#delete_cluster_workflow_template\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @return [IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplate]
    def get_cluster_workflow_template(name, opts = {})
      data, _status_code, _headers = get_cluster_workflow_template_with_http_info(name, opts)
      data
    end
    ...
    # @option opts [String] :get_options_resource_version resourceVersion sets a constraint on what resource versions a request may be served from. See https://kubernetes.io/docs/reference/using-api/api-concepts/#resource-versions for details.  Defaults to unset +optional
    # @return [Array<(IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplate, Integer, Hash)>] IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplate data, response status code and response headers
    def get_cluster_workflow_template_with_http_info(name, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ClusterWorkflowTemplateServiceApi.get_cluster_workflow_template ...'
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling ClusterWorkflowTemplateServiceApi.get_cluster_workflow_template"
      end
      # resource path
      local_var_path = '/api/v1/cluster-workflow-templates/{name}'.sub('{' + 'name' + '}', CGI.escape(name.to_s))
      ...
      new_options = opts.merge(
        :operation => :"ClusterWorkflowTemplateServiceApi.get_cluster_workflow_template",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ClusterWorkflowTemplateServiceApi#get_cluster_workflow_template\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end

    # @param body [IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplateLintRequest] 
    # @param [Hash] opts the optional parameters
    # @return [IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplate]
    def lint_cluster_workflow_template(body, opts = {})
      data, _status_code, _headers = lint_cluster_workflow_template_with_http_info(body, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplate, Integer, Hash)>] IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplate data, response status code and response headers
    def lint_cluster_workflow_template_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ClusterWorkflowTemplateServiceApi.lint_cluster_workflow_template ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ClusterWorkflowTemplateServiceApi.lint_cluster_workflow_template"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"ClusterWorkflowTemplateServiceApi.lint_cluster_workflow_template",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ClusterWorkflowTemplateServiceApi#lint_cluster_workflow_template\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def list_cluster_workflow_templates(opts = {})
      data, _status_code, _headers = list_cluster_workflow_templates_with_http_info(opts)
      data
    end
    ...
    # @option opts [String] :list_options_limit limit is a maximum number of responses to return for a list call. If more items exist, the server will set the &#x60;continue&#x60; field on the list metadata to a value that can be used with the same initial query to retrieve the next set of results. Setting a limit may return fewer than the requested amount of items (up to zero items) in the event all requested objects are filtered out and clients should only use the presence of the continue field to determine whether more results are available. Servers may choose not to support the limit argument and will return all of the available results. If limit is specified and the continue field is empty, clients may assume that no more results are available. This field is not supported if watch is true.  The server guarantees that the objects returned when using continue will be identical to issuing a single list call without a limit - that is, no objects created, modified, or deleted after the first request is issued will be included in any subsequent continued requests. This is sometimes referred to as a consistent snapshot, and ensures that a client that is using limit to receive smaller chunks of a very large result can ensure they see all possible objects. If objects are updated during a chunked list the version of the object that was present at the time the first list result was calculated is returned.
    # @option opts [String] :list_options_continue The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the \&quot;next key\&quot;.  This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.
    # @return [Array<(IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplateList, Integer, Hash)>] IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplateList data, response status code and response headers
    def list_cluster_workflow_templates_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ClusterWorkflowTemplateServiceApi.list_cluster_workflow_templates ...'
      end
      # resource path
      local_var_path = '/api/v1/cluster-workflow-templates'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplateList'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"ClusterWorkflowTemplateServiceApi.list_cluster_workflow_templates",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ClusterWorkflowTemplateServiceApi#list_cluster_workflow_templates\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end

    # @param name [String] DEPRECATED: This field is ignored.
    # @param body [IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplateUpdateRequest] 
    # @param [Hash] opts the optional parameters
    # @return [IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplate]
    def update_cluster_workflow_template(name, body, opts = {})
      data, _status_code, _headers = update_cluster_workflow_template_with_http_info(name, body, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplate, Integer, Hash)>] IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplate data, response status code and response headers
    def update_cluster_workflow_template_with_http_info(name, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ClusterWorkflowTemplateServiceApi.update_cluster_workflow_template ...'
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling ClusterWorkflowTemplateServiceApi.update_cluster_workflow_template"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ClusterWorkflowTemplateServiceApi.update_cluster_workflow_template"
      end
      # resource path
      local_var_path = '/api/v1/cluster-workflow-templates/{name}'.sub('{' + 'name' + '}', CGI.escape(name.to_s))
      ...
      new_options = opts.merge(
        :operation => :"ClusterWorkflowTemplateServiceApi.update_cluster_workflow_template",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ClusterWorkflowTemplateServiceApi#update_cluster_workflow_template\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
