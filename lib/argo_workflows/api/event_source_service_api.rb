...
module ArgoWorkflows
  class EventSourceServiceApi
    ...
    # @param body [EventsourceCreateEventSourceRequest] 
    # @param [Hash] opts the optional parameters
    # @return [IoArgoprojEventsV1alpha1EventSource]
    def create_event_source(namespace, body, opts = {})
      data, _status_code, _headers = create_event_source_with_http_info(namespace, body, opts)
      data
    end
    ...
    # @param body [EventsourceCreateEventSourceRequest] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(IoArgoprojEventsV1alpha1EventSource, Integer, Hash)>] IoArgoprojEventsV1alpha1EventSource data, response status code and response headers
    def create_event_source_with_http_info(namespace, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EventSourceServiceApi.create_event_source ...'
      end
      # verify the required parameter 'namespace' is set
      if @api_client.config.client_side_validation && namespace.nil?
        fail ArgumentError, "Missing the required parameter 'namespace' when calling EventSourceServiceApi.create_event_source"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling EventSourceServiceApi.create_event_source"
      end
      # resource path
      local_var_path = '/api/v1/event-sources/{namespace}'.sub('{' + 'namespace' + '}', CGI.escape(namespace.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'IoArgoprojEventsV1alpha1EventSource'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"EventSourceServiceApi.create_event_source",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EventSourceServiceApi#create_event_source\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @return [Object]
    def delete_event_source(namespace, name, opts = {})
      data, _status_code, _headers = delete_event_source_with_http_info(namespace, name, opts)
      data
    end
    ...
    def delete_event_source_with_http_info(namespace, name, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EventSourceServiceApi.delete_event_source ...'
      end
      # verify the required parameter 'namespace' is set
      if @api_client.config.client_side_validation && namespace.nil?
        fail ArgumentError, "Missing the required parameter 'namespace' when calling EventSourceServiceApi.delete_event_source"
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling EventSourceServiceApi.delete_event_source"
      end
      # resource path
      local_var_path = '/api/v1/event-sources/{namespace}/{name}'.sub('{' + 'namespace' + '}', CGI.escape(namespace.to_s)).sub('{' + 'name' + '}', CGI.escape(name.to_s))
      ...
      new_options = opts.merge(
        :operation => :"EventSourceServiceApi.delete_event_source",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EventSourceServiceApi#delete_event_source\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def event_sources_logs(namespace, opts = {})
      data, _status_code, _headers = event_sources_logs_with_http_info(namespace, opts)
      data
    end
    ...
    # @option opts [String] :pod_log_options_limit_bytes If set, the number of bytes to read from the server before terminating the log output. This may not display a complete final line of logging, and may return slightly more or slightly less than the specified limit. +optional.
    # @option opts [Boolean] :pod_log_options_insecure_skip_tls_verify_backend insecureSkipTLSVerifyBackend indicates that the apiserver should not confirm the validity of the serving certificate of the backend it is connecting to.  This will make the HTTPS connection between the apiserver and the backend insecure. This means the apiserver cannot verify the log data it is receiving came from the real kubelet.  If the kubelet is configured to verify the apiserver&#39;s TLS credentials, it does not mean the connection to the real kubelet is vulnerable to a man in the middle attack (e.g. an attacker could not intercept the actual log data coming from the real kubelet). +optional.
    # @return [Array<(StreamResultOfEventsourceLogEntry, Integer, Hash)>] StreamResultOfEventsourceLogEntry data, response status code and response headers
    def event_sources_logs_with_http_info(namespace, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EventSourceServiceApi.event_sources_logs ...'
      end
      # verify the required parameter 'namespace' is set
      if @api_client.config.client_side_validation && namespace.nil?
        fail ArgumentError, "Missing the required parameter 'namespace' when calling EventSourceServiceApi.event_sources_logs"
      end
      # resource path
      local_var_path = '/api/v1/stream/event-sources/{namespace}/logs'.sub('{' + 'namespace' + '}', CGI.escape(namespace.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'StreamResultOfEventsourceLogEntry'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"EventSourceServiceApi.event_sources_logs",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EventSourceServiceApi#event_sources_logs\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [IoArgoprojEventsV1alpha1EventSource]
    def get_event_source(namespace, name, opts = {})
      data, _status_code, _headers = get_event_source_with_http_info(namespace, name, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(IoArgoprojEventsV1alpha1EventSource, Integer, Hash)>] IoArgoprojEventsV1alpha1EventSource data, response status code and response headers
    def get_event_source_with_http_info(namespace, name, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EventSourceServiceApi.get_event_source ...'
      end
      # verify the required parameter 'namespace' is set
      if @api_client.config.client_side_validation && namespace.nil?
        fail ArgumentError, "Missing the required parameter 'namespace' when calling EventSourceServiceApi.get_event_source"
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling EventSourceServiceApi.get_event_source"
      end
      # resource path
      local_var_path = '/api/v1/event-sources/{namespace}/{name}'.sub('{' + 'namespace' + '}', CGI.escape(namespace.to_s)).sub('{' + 'name' + '}', CGI.escape(name.to_s))
      ...
      new_options = opts.merge(
        :operation => :"EventSourceServiceApi.get_event_source",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EventSourceServiceApi#get_event_source\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def list_event_sources(namespace, opts = {})
      data, _status_code, _headers = list_event_sources_with_http_info(namespace, opts)
      data
    end
    ...
    # @option opts [String] :list_options_limit limit is a maximum number of responses to return for a list call. If more items exist, the server will set the &#x60;continue&#x60; field on the list metadata to a value that can be used with the same initial query to retrieve the next set of results. Setting a limit may return fewer than the requested amount of items (up to zero items) in the event all requested objects are filtered out and clients should only use the presence of the continue field to determine whether more results are available. Servers may choose not to support the limit argument and will return all of the available results. If limit is specified and the continue field is empty, clients may assume that no more results are available. This field is not supported if watch is true.  The server guarantees that the objects returned when using continue will be identical to issuing a single list call without a limit - that is, no objects created, modified, or deleted after the first request is issued will be included in any subsequent continued requests. This is sometimes referred to as a consistent snapshot, and ensures that a client that is using limit to receive smaller chunks of a very large result can ensure they see all possible objects. If objects are updated during a chunked list the version of the object that was present at the time the first list result was calculated is returned.
    # @option opts [String] :list_options_continue The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the \&quot;next key\&quot;.  This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.
    # @return [Array<(IoArgoprojEventsV1alpha1EventSourceList, Integer, Hash)>] IoArgoprojEventsV1alpha1EventSourceList data, response status code and response headers
    def list_event_sources_with_http_info(namespace, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EventSourceServiceApi.list_event_sources ...'
      end
      # verify the required parameter 'namespace' is set
      if @api_client.config.client_side_validation && namespace.nil?
        fail ArgumentError, "Missing the required parameter 'namespace' when calling EventSourceServiceApi.list_event_sources"
      end
      # resource path
      local_var_path = '/api/v1/event-sources/{namespace}'.sub('{' + 'namespace' + '}', CGI.escape(namespace.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'IoArgoprojEventsV1alpha1EventSourceList'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"EventSourceServiceApi.list_event_sources",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EventSourceServiceApi#list_event_sources\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param namespace [String] 
    # @param name [String] 
    # @param body [EventsourceUpdateEventSourceRequest] 
    # @param [Hash] opts the optional parameters
    # @return [IoArgoprojEventsV1alpha1EventSource]
    def update_event_source(namespace, name, body, opts = {})
      data, _status_code, _headers = update_event_source_with_http_info(namespace, name, body, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(IoArgoprojEventsV1alpha1EventSource, Integer, Hash)>] IoArgoprojEventsV1alpha1EventSource data, response status code and response headers
    def update_event_source_with_http_info(namespace, name, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EventSourceServiceApi.update_event_source ...'
      end
      # verify the required parameter 'namespace' is set
      if @api_client.config.client_side_validation && namespace.nil?
        fail ArgumentError, "Missing the required parameter 'namespace' when calling EventSourceServiceApi.update_event_source"
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling EventSourceServiceApi.update_event_source"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling EventSourceServiceApi.update_event_source"
      end
      # resource path
      local_var_path = '/api/v1/event-sources/{namespace}/{name}'.sub('{' + 'namespace' + '}', CGI.escape(namespace.to_s)).sub('{' + 'name' + '}', CGI.escape(name.to_s))
      ...
      new_options = opts.merge(
        :operation => :"EventSourceServiceApi.update_event_source",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EventSourceServiceApi#update_event_source\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def watch_event_sources(namespace, opts = {})
      data, _status_code, _headers = watch_event_sources_with_http_info(namespace, opts)
      data
    end
    ...
    # @option opts [String] :list_options_limit limit is a maximum number of responses to return for a list call. If more items exist, the server will set the &#x60;continue&#x60; field on the list metadata to a value that can be used with the same initial query to retrieve the next set of results. Setting a limit may return fewer than the requested amount of items (up to zero items) in the event all requested objects are filtered out and clients should only use the presence of the continue field to determine whether more results are available. Servers may choose not to support the limit argument and will return all of the available results. If limit is specified and the continue field is empty, clients may assume that no more results are available. This field is not supported if watch is true.  The server guarantees that the objects returned when using continue will be identical to issuing a single list call without a limit - that is, no objects created, modified, or deleted after the first request is issued will be included in any subsequent continued requests. This is sometimes referred to as a consistent snapshot, and ensures that a client that is using limit to receive smaller chunks of a very large result can ensure they see all possible objects. If objects are updated during a chunked list the version of the object that was present at the time the first list result was calculated is returned.
    # @option opts [String] :list_options_continue The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the \&quot;next key\&quot;.  This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.
    # @return [Array<(StreamResultOfEventsourceEventSourceWatchEvent, Integer, Hash)>] StreamResultOfEventsourceEventSourceWatchEvent data, response status code and response headers
    def watch_event_sources_with_http_info(namespace, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EventSourceServiceApi.watch_event_sources ...'
      end
      # verify the required parameter 'namespace' is set
      if @api_client.config.client_side_validation && namespace.nil?
        fail ArgumentError, "Missing the required parameter 'namespace' when calling EventSourceServiceApi.watch_event_sources"
      end
      # resource path
      local_var_path = '/api/v1/stream/event-sources/{namespace}'.sub('{' + 'namespace' + '}', CGI.escape(namespace.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'StreamResultOfEventsourceEventSourceWatchEvent'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"EventSourceServiceApi.watch_event_sources",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EventSourceServiceApi#watch_event_sources\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
