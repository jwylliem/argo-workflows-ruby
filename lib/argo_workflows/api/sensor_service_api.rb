...
module ArgoWorkflows
  class SensorServiceApi
    ...
    # @param body [SensorCreateSensorRequest] 
    # @param [Hash] opts the optional parameters
    # @return [IoArgoprojEventsV1alpha1Sensor]
    def create_sensor(namespace, body, opts = {})
      data, _status_code, _headers = create_sensor_with_http_info(namespace, body, opts)
      data
    end
    ...
    # @param body [SensorCreateSensorRequest] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(IoArgoprojEventsV1alpha1Sensor, Integer, Hash)>] IoArgoprojEventsV1alpha1Sensor data, response status code and response headers
    def create_sensor_with_http_info(namespace, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SensorServiceApi.create_sensor ...'
      end
      # verify the required parameter 'namespace' is set
      if @api_client.config.client_side_validation && namespace.nil?
        fail ArgumentError, "Missing the required parameter 'namespace' when calling SensorServiceApi.create_sensor"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling SensorServiceApi.create_sensor"
      end
      # resource path
      local_var_path = '/api/v1/sensors/{namespace}'.sub('{' + 'namespace' + '}', CGI.escape(namespace.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'IoArgoprojEventsV1alpha1Sensor'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"SensorServiceApi.create_sensor",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SensorServiceApi#create_sensor\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @return [Object]
    def delete_sensor(namespace, name, opts = {})
      data, _status_code, _headers = delete_sensor_with_http_info(namespace, name, opts)
      data
    end
    ...
    def delete_sensor_with_http_info(namespace, name, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SensorServiceApi.delete_sensor ...'
      end
      # verify the required parameter 'namespace' is set
      if @api_client.config.client_side_validation && namespace.nil?
        fail ArgumentError, "Missing the required parameter 'namespace' when calling SensorServiceApi.delete_sensor"
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling SensorServiceApi.delete_sensor"
      end
      # resource path
      local_var_path = '/api/v1/sensors/{namespace}/{name}'.sub('{' + 'namespace' + '}', CGI.escape(namespace.to_s)).sub('{' + 'name' + '}', CGI.escape(name.to_s))
      ...
      new_options = opts.merge(
        :operation => :"SensorServiceApi.delete_sensor",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SensorServiceApi#delete_sensor\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @return [IoArgoprojEventsV1alpha1Sensor]
    def get_sensor(namespace, name, opts = {})
      data, _status_code, _headers = get_sensor_with_http_info(namespace, name, opts)
      data
    end
    ...
    # @option opts [String] :get_options_resource_version resourceVersion sets a constraint on what resource versions a request may be served from. See https://kubernetes.io/docs/reference/using-api/api-concepts/#resource-versions for details.  Defaults to unset +optional
    # @return [Array<(IoArgoprojEventsV1alpha1Sensor, Integer, Hash)>] IoArgoprojEventsV1alpha1Sensor data, response status code and response headers
    def get_sensor_with_http_info(namespace, name, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SensorServiceApi.get_sensor ...'
      end
      # verify the required parameter 'namespace' is set
      if @api_client.config.client_side_validation && namespace.nil?
        fail ArgumentError, "Missing the required parameter 'namespace' when calling SensorServiceApi.get_sensor"
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling SensorServiceApi.get_sensor"
      end
      # resource path
      local_var_path = '/api/v1/sensors/{namespace}/{name}'.sub('{' + 'namespace' + '}', CGI.escape(namespace.to_s)).sub('{' + 'name' + '}', CGI.escape(name.to_s))
      ...
      new_options = opts.merge(
        :operation => :"SensorServiceApi.get_sensor",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SensorServiceApi#get_sensor\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def list_sensors(namespace, opts = {})
      data, _status_code, _headers = list_sensors_with_http_info(namespace, opts)
      data
    end
    ...
    # @option opts [String] :list_options_limit limit is a maximum number of responses to return for a list call. If more items exist, the server will set the &#x60;continue&#x60; field on the list metadata to a value that can be used with the same initial query to retrieve the next set of results. Setting a limit may return fewer than the requested amount of items (up to zero items) in the event all requested objects are filtered out and clients should only use the presence of the continue field to determine whether more results are available. Servers may choose not to support the limit argument and will return all of the available results. If limit is specified and the continue field is empty, clients may assume that no more results are available. This field is not supported if watch is true.  The server guarantees that the objects returned when using continue will be identical to issuing a single list call without a limit - that is, no objects created, modified, or deleted after the first request is issued will be included in any subsequent continued requests. This is sometimes referred to as a consistent snapshot, and ensures that a client that is using limit to receive smaller chunks of a very large result can ensure they see all possible objects. If objects are updated during a chunked list the version of the object that was present at the time the first list result was calculated is returned.
    # @option opts [String] :list_options_continue The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the \&quot;next key\&quot;.  This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.
    # @return [Array<(IoArgoprojEventsV1alpha1SensorList, Integer, Hash)>] IoArgoprojEventsV1alpha1SensorList data, response status code and response headers
    def list_sensors_with_http_info(namespace, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SensorServiceApi.list_sensors ...'
      end
      # verify the required parameter 'namespace' is set
      if @api_client.config.client_side_validation && namespace.nil?
        fail ArgumentError, "Missing the required parameter 'namespace' when calling SensorServiceApi.list_sensors"
      end
      # resource path
      local_var_path = '/api/v1/sensors/{namespace}'.sub('{' + 'namespace' + '}', CGI.escape(namespace.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'IoArgoprojEventsV1alpha1SensorList'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"SensorServiceApi.list_sensors",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SensorServiceApi#list_sensors\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def sensors_logs(namespace, opts = {})
      data, _status_code, _headers = sensors_logs_with_http_info(namespace, opts)
      data
    end
    ...
    # @option opts [String] :pod_log_options_limit_bytes If set, the number of bytes to read from the server before terminating the log output. This may not display a complete final line of logging, and may return slightly more or slightly less than the specified limit. +optional.
    # @option opts [Boolean] :pod_log_options_insecure_skip_tls_verify_backend insecureSkipTLSVerifyBackend indicates that the apiserver should not confirm the validity of the serving certificate of the backend it is connecting to.  This will make the HTTPS connection between the apiserver and the backend insecure. This means the apiserver cannot verify the log data it is receiving came from the real kubelet.  If the kubelet is configured to verify the apiserver&#39;s TLS credentials, it does not mean the connection to the real kubelet is vulnerable to a man in the middle attack (e.g. an attacker could not intercept the actual log data coming from the real kubelet). +optional.
    # @return [Array<(StreamResultOfSensorLogEntry, Integer, Hash)>] StreamResultOfSensorLogEntry data, response status code and response headers
    def sensors_logs_with_http_info(namespace, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SensorServiceApi.sensors_logs ...'
      end
      # verify the required parameter 'namespace' is set
      if @api_client.config.client_side_validation && namespace.nil?
        fail ArgumentError, "Missing the required parameter 'namespace' when calling SensorServiceApi.sensors_logs"
      end
      # resource path
      local_var_path = '/api/v1/stream/sensors/{namespace}/logs'.sub('{' + 'namespace' + '}', CGI.escape(namespace.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'StreamResultOfSensorLogEntry'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"SensorServiceApi.sensors_logs",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SensorServiceApi#sensors_logs\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param namespace [String] 
    # @param name [String] 
    # @param body [SensorUpdateSensorRequest] 
    # @param [Hash] opts the optional parameters
    # @return [IoArgoprojEventsV1alpha1Sensor]
    def update_sensor(namespace, name, body, opts = {})
      data, _status_code, _headers = update_sensor_with_http_info(namespace, name, body, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(IoArgoprojEventsV1alpha1Sensor, Integer, Hash)>] IoArgoprojEventsV1alpha1Sensor data, response status code and response headers
    def update_sensor_with_http_info(namespace, name, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SensorServiceApi.update_sensor ...'
      end
      # verify the required parameter 'namespace' is set
      if @api_client.config.client_side_validation && namespace.nil?
        fail ArgumentError, "Missing the required parameter 'namespace' when calling SensorServiceApi.update_sensor"
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling SensorServiceApi.update_sensor"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling SensorServiceApi.update_sensor"
      end
      # resource path
      local_var_path = '/api/v1/sensors/{namespace}/{name}'.sub('{' + 'namespace' + '}', CGI.escape(namespace.to_s)).sub('{' + 'name' + '}', CGI.escape(name.to_s))
      ...
      new_options = opts.merge(
        :operation => :"SensorServiceApi.update_sensor",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SensorServiceApi#update_sensor\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def watch_sensors(namespace, opts = {})
      data, _status_code, _headers = watch_sensors_with_http_info(namespace, opts)
      data
    end
    ...
    # @option opts [String] :list_options_limit limit is a maximum number of responses to return for a list call. If more items exist, the server will set the &#x60;continue&#x60; field on the list metadata to a value that can be used with the same initial query to retrieve the next set of results. Setting a limit may return fewer than the requested amount of items (up to zero items) in the event all requested objects are filtered out and clients should only use the presence of the continue field to determine whether more results are available. Servers may choose not to support the limit argument and will return all of the available results. If limit is specified and the continue field is empty, clients may assume that no more results are available. This field is not supported if watch is true.  The server guarantees that the objects returned when using continue will be identical to issuing a single list call without a limit - that is, no objects created, modified, or deleted after the first request is issued will be included in any subsequent continued requests. This is sometimes referred to as a consistent snapshot, and ensures that a client that is using limit to receive smaller chunks of a very large result can ensure they see all possible objects. If objects are updated during a chunked list the version of the object that was present at the time the first list result was calculated is returned.
    # @option opts [String] :list_options_continue The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the \&quot;next key\&quot;.  This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.
    # @return [Array<(StreamResultOfSensorSensorWatchEvent, Integer, Hash)>] StreamResultOfSensorSensorWatchEvent data, response status code and response headers
    def watch_sensors_with_http_info(namespace, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SensorServiceApi.watch_sensors ...'
      end
      # verify the required parameter 'namespace' is set
      if @api_client.config.client_side_validation && namespace.nil?
        fail ArgumentError, "Missing the required parameter 'namespace' when calling SensorServiceApi.watch_sensors"
      end
      # resource path
      local_var_path = '/api/v1/stream/sensors/{namespace}'.sub('{' + 'namespace' + '}', CGI.escape(namespace.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'StreamResultOfSensorSensorWatchEvent'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"SensorServiceApi.watch_sensors",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SensorServiceApi#watch_sensors\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
