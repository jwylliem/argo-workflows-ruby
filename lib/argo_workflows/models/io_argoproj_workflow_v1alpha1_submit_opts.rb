  ...
  class IoArgoprojWorkflowV1alpha1SubmitOpts
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ArgoWorkflows::IoArgoprojWorkflowV1alpha1SubmitOpts` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ArgoWorkflows::IoArgoprojWorkflowV1alpha1SubmitOpts`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'parameter_file')
        self.parameter_file = attributes[:'parameter_file']
      end
      ...
      if attributes.key?(:'server_dry_run')
        self.server_dry_run = attributes[:'server_dry_run']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          parameter_file == o.parameter_file &&
    ...
    def hash
      [annotations, dry_run, entry_point, generate_name, labels, name, owner_reference, parameter_file, parameters, pod_priority_class_name, priority, server_dry_run, service_account].hash
    end
