...
describe 'CronWorkflowServiceApi' do
  ...
  describe 'test an instance of CronWorkflowServiceApi' do
    it 'should create an instance of CronWorkflowServiceApi' do
      expect(@api_instance).to be_instance_of(ArgoWorkflows::CronWorkflowServiceApi)
    end
  end

  # unit tests for create_cron_workflow
  # @param namespace 
  # @param body 
  # @param [Hash] opts the optional parameters
  # @return [IoArgoprojWorkflowV1alpha1CronWorkflow]
  describe 'create_cron_workflow test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for delete_cron_workflow
  # @param namespace 
  # @param name 
  # @param [Hash] opts the optional parameters
  ...
  # @return [Object]
  describe 'delete_cron_workflow test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_cron_workflow
  # @param namespace 
  # @param name 
  # @param [Hash] opts the optional parameters
  ...
  # @return [IoArgoprojWorkflowV1alpha1CronWorkflow]
  describe 'get_cron_workflow test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for lint_cron_workflow
  # @param namespace 
  # @param body 
  # @param [Hash] opts the optional parameters
  # @return [IoArgoprojWorkflowV1alpha1CronWorkflow]
  describe 'lint_cron_workflow test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for list_cron_workflows
  # @param namespace 
  # @param [Hash] opts the optional parameters
  ...
  describe 'list_cron_workflows test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for resume_cron_workflow
  # @param namespace 
  # @param name 
  # @param body 
  # @param [Hash] opts the optional parameters
  # @return [IoArgoprojWorkflowV1alpha1CronWorkflow]
  describe 'resume_cron_workflow test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for suspend_cron_workflow
  # @param namespace 
  # @param name 
  # @param body 
  # @param [Hash] opts the optional parameters
  # @return [IoArgoprojWorkflowV1alpha1CronWorkflow]
  describe 'suspend_cron_workflow test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for update_cron_workflow
  # @param namespace 
  # @param name DEPRECATED: This field is ignored.
  # @param body 
  # @param [Hash] opts the optional parameters
  # @return [IoArgoprojWorkflowV1alpha1CronWorkflow]
  describe 'update_cron_workflow test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
