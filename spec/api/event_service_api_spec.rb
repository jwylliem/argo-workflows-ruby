...
describe 'EventServiceApi' do
  ...
  describe 'test an instance of EventServiceApi' do
    it 'should create an instance of EventServiceApi' do
      expect(@api_instance).to be_instance_of(ArgoWorkflows::EventServiceApi)
    end
  end

  # unit tests for list_workflow_event_bindings
  # @param namespace 
  ...
  describe 'list_workflow_event_bindings test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for receive_event
  ...
  # @param [Hash] opts the optional parameters
  # @return [Object]
  describe 'receive_event test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
