...
describe 'EventSourceServiceApi' do
  ...
  describe 'test an instance of EventSourceServiceApi' do
    it 'should create an instance of EventSourceServiceApi' do
      expect(@api_instance).to be_instance_of(ArgoWorkflows::EventSourceServiceApi)
    end
  end

  # unit tests for create_event_source
  # @param namespace 
  # @param body 
  # @param [Hash] opts the optional parameters
  # @return [IoArgoprojEventsV1alpha1EventSource]
  describe 'create_event_source test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for delete_event_source
  # @param namespace 
  # @param name 
  # @param [Hash] opts the optional parameters
  ...
  # @return [Object]
  describe 'delete_event_source test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for event_sources_logs
  # @param namespace 
  # @param [Hash] opts the optional parameters
  ...
  describe 'event_sources_logs test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_event_source
  # @param namespace 
  # @param name 
  # @param [Hash] opts the optional parameters
  # @return [IoArgoprojEventsV1alpha1EventSource]
  describe 'get_event_source test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for list_event_sources
  # @param namespace 
  # @param [Hash] opts the optional parameters
  ...
  describe 'list_event_sources test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for update_event_source
  # @param namespace 
  # @param name 
  # @param body 
  # @param [Hash] opts the optional parameters
  # @return [IoArgoprojEventsV1alpha1EventSource]
  describe 'update_event_source test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for watch_event_sources
  # @param namespace 
  # @param [Hash] opts the optional parameters
  # @option opts [String] :list_options_label_selector A selector to restrict the list of returned objects by their labels. Defaults to everything. +optional.
  # @option opts [String] :list_options_field_selector A selector to restrict the list of returned objects by their fields. Defaults to everything. +optional.
  ...
  describe 'watch_event_sources test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
