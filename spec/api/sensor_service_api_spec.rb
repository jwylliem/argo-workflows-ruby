...
describe 'SensorServiceApi' do
  ...
  describe 'test an instance of SensorServiceApi' do
    it 'should create an instance of SensorServiceApi' do
      expect(@api_instance).to be_instance_of(ArgoWorkflows::SensorServiceApi)
    end
  end

  # unit tests for create_sensor
  # @param namespace 
  # @param body 
  # @param [Hash] opts the optional parameters
  # @return [IoArgoprojEventsV1alpha1Sensor]
  describe 'create_sensor test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for delete_sensor
  # @param namespace 
  # @param name 
  # @param [Hash] opts the optional parameters
  ...
  # @return [Object]
  describe 'delete_sensor test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_sensor
  # @param namespace 
  # @param name 
  # @param [Hash] opts the optional parameters
  ...
  # @return [IoArgoprojEventsV1alpha1Sensor]
  describe 'get_sensor test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for list_sensors
  # @param namespace 
  # @param [Hash] opts the optional parameters
  ...
  describe 'list_sensors test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for sensors_logs
  # @param namespace 
  # @param [Hash] opts the optional parameters
  ...
  describe 'sensors_logs test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for update_sensor
  # @param namespace 
  # @param name 
  # @param body 
  # @param [Hash] opts the optional parameters
  # @return [IoArgoprojEventsV1alpha1Sensor]
  describe 'update_sensor test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for watch_sensors
  # @param namespace 
  # @param [Hash] opts the optional parameters
  # @option opts [String] :list_options_label_selector A selector to restrict the list of returned objects by their labels. Defaults to everything. +optional.
  # @option opts [String] :list_options_field_selector A selector to restrict the list of returned objects by their fields. Defaults to everything. +optional.
  ...
  describe 'watch_sensors test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
