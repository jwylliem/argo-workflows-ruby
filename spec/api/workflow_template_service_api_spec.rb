...
describe 'WorkflowTemplateServiceApi' do
  ...
  describe 'test an instance of WorkflowTemplateServiceApi' do
    it 'should create an instance of WorkflowTemplateServiceApi' do
      expect(@api_instance).to be_instance_of(ArgoWorkflows::WorkflowTemplateServiceApi)
    end
  end

  # unit tests for create_workflow_template
  # @param namespace 
  # @param body 
  # @param [Hash] opts the optional parameters
  # @return [IoArgoprojWorkflowV1alpha1WorkflowTemplate]
  describe 'create_workflow_template test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for delete_workflow_template
  # @param namespace 
  # @param name 
  # @param [Hash] opts the optional parameters
  ...
  # @return [Object]
  describe 'delete_workflow_template test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_workflow_template
  # @param namespace 
  # @param name 
  # @param [Hash] opts the optional parameters
  ...
  # @return [IoArgoprojWorkflowV1alpha1WorkflowTemplate]
  describe 'get_workflow_template test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for lint_workflow_template
  # @param namespace 
  # @param body 
  # @param [Hash] opts the optional parameters
  # @return [IoArgoprojWorkflowV1alpha1WorkflowTemplate]
  describe 'lint_workflow_template test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for list_workflow_templates
  # @param namespace 
  # @param [Hash] opts the optional parameters
  ...
  describe 'list_workflow_templates test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for update_workflow_template
  # @param namespace 
  # @param name DEPRECATED: This field is ignored.
  # @param body 
  # @param [Hash] opts the optional parameters
  # @return [IoArgoprojWorkflowV1alpha1WorkflowTemplate]
  describe 'update_workflow_template test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
